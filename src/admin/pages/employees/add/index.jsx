import { Button, FormControl, InputLabel, MenuItem, Select, TextField, useTheme, Box } from '@mui/material';
  ...
  return (
    <Box m="20px">
      ...
      <Box m="10px 0" display="flex" alignItems="center" justifyContent="center" width="100%" flexDirection="column">
        ...
        <CssTextField label="Email" colors={colors} colorMode={colorMode} theme={theme} width="40%" margin="10px 0" type="email" />
        <CssTextField label="Phone" colors={colors} colorMode={colorMode} theme={theme} width="40%" margin="10px 0" />
        <FormControl
          sx={{
            width: '40%',
            margin: '10px 0',
        ...
        <CssTextField label="Username" colors={colors} colorMode={colorMode} theme={theme} width="40%" margin="10px 0" />
        <CssTextField label="Password" colors={colors} colorMode={colorMode} theme={theme} width="40%" margin="10px 0" type="password" />
        <Button
          variant="primary"
          sx={{
            width: '40%',
